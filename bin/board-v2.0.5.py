...
def cmd_sync(dry_run: bool, json_mode: bool, force: bool = False, app_filter: str = None):
    ...
    if dry_run:
        ...
        if total:
            ...
            print("Run 'board sync' or 'board sync --force' to apply.")
        else:
...
def usage():
    ...
    print("  board sync --force      - Pull repo and overwrite existing apps")
...
def main():
    ...
    SUBCOMMANDS = ["list", "show", "use", "add", "remove", "pat", "push", "sync"]
