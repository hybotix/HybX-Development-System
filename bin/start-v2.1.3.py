...
v2.1.3: Non-main scripts resolved from app root, not python/.

Usage:
  start <app_name>                  (runs python/main.py)
  start <app_name> <script.py>      (runs <script.py> in app root)
...
def main():
    ...
    if script == "main.py":
        ...
        main_py = os.path.join(app_path, script)
        cwd     = app_path
