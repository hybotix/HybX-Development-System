...
class HybXRunner:
    ...
    def start(self, app_args: list = None) -> RunnerResult:
        """Start the app container.
        
        app_args: optional list of extra arguments passed to main.py
        """
        t0 = time.time()
        ...
        # Extra args passed to main.py inside the container
        if app_args:
            cmd += [str(a) for a in app_args]
