...
def main():
    ...
    # Derive project name from sketch path
    # Expects: .../Arduino/UNO-Q/<project>/sketch/
    #      or: .../Arduino/UNO-Q/<project>/
    parts   = os.path.normpath(sketch_path).split(os.sep)
    # Walk up from the end to find the project name —
    # it is the directory directly under the board apps dir,
    # so skip trailing "sketch" component if present
    project = None
