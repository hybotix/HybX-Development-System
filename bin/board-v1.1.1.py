...
Usage:
  ...
  board sync --force      - Pull repo and overwrite existing apps (local changes lost)
...
def sync_apps(
        ...
        dry_run: bool,
        json_mode: bool,
        force: bool = False) -> tuple[list, list, list]:
    """
...
def cmd_sync(dry_run: bool, json_mode: bool, force: bool = False):
    """
    ...
    added, updated, skipped = sync_apps(
        repo_path, board_name, apps_path, dry_run, json_mode, force
    )
...
def main():
    ...
    if command == "list":
        ...
        cmd_sync(dry_run, json_mode, force)
